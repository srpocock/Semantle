const cardRegion: HTMLElement | null = document.querySelector('.card-region');
const card: HTMLElement | null = document.querySelector('.card');

cardRegion?.addEventListener('mousemove', function (event) {
...
cardRegion?.addEventListener('mouseleave', function () {
    if (card) {
